...
const contactItems = [
  { key: "email" as const,    value: "jcthompson209@gmail.com",            href: null },
  { key: "phone" as const,    value: "+31 683 83 78 60",                   href: null },
  { key: "linkedin" as const, value: "Jose C. Thompson",                   href: "https://www.linkedin.com/in/jose-c-thompson/" },
];
        ...
        <div className="md:pt-12 flex flex-col">
          {contactItems.map((item) => {
            ...
            return item.href ? (
              ...
              <div key={item.key} className={`${rowClass} cursor-text`}>
                {inner}
              </div>
            );
          })}
